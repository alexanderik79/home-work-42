    ...
    <div className="home-page">
      ...
      <section className="cta-section">
        <div className="cta-content">
          <h2 data-aos="fade-up" data-aos-delay="100">Ready to experience the difference?</h2>
          <p data-aos="fade-up" data-aos-delay="300">Book a service appointment or schedule a test drive today!</p>
          <Link 
            data-aos="fade-up" 
            data-aos-delay="500" 
            data-aos-offset="-100"
